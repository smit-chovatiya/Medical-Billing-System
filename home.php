                ...
                <div class="leftbox">
                    <div class="login_form">
                        ...
                        <form class="form"  action="Login.php"  method="post">
                            ...
                            <input id="uname" type="text" name="uname" placeholder="Enter Username" require><br><br>

                            <label for="password">Password:</label><br>
                            <input id="password" type="password" name="password" placeholder="Enter Password" require><br>
